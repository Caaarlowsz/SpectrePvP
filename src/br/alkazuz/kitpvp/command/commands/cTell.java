...
public boolean onCommand(CommandSender Sender, Command Cmd, String Label, String[] Args){
    ...
    if (Cmd.getName().equalsIgnoreCase("r")){
    	...
    	if (aw == null||br.alkazuz.kitpvp.api.API.admin.contains(aw)&&!GroupAPI.GroupCanExecute(GroupAPI.getGroup(p), "banid")){
    ...
    if (Cmd.getName().equalsIgnoreCase("tell")){
        ...
        if (tell == null||br.alkazuz.kitpvp.api.API.admin.contains(tell)&&!p.hasPermission("kitpvp.admin")){
     		p.sendMessage("§7Esse player não está online");	
          return true;
        }
        if (tell == p){
    	...
    	if(br.alkazuz.kitpvp.api.API.admin.contains(tell)&&!p.hasPermission("kitpvp.admin")){
     		p.sendMessage("§7Esse player não está online");	
        	return true;
        }
