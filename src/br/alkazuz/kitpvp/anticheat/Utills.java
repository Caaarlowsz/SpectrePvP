package br.alkazuz.kitpvp.anticheat;
...
public class Utills {
	...
	public static enum Hack {
		...
		FASTCLICKTALVEZ(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Talvez estar (" + API.RED
				+ "Clicando muito Rápido" + API.GRAY + ") clicks Click's " + API.DARK_RED + "[" + "avisos" + "]"
				+ API.GRAY + "!"),
		FASTCLICKPROVAVELMENTE(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Provavelmente estar ("
				+ API.RED + "Clicando muito Rápido" + API.GRAY + ") clicks Click's " + API.DARK_RED + "[" + "avisos"
				+ "]" + API.GRAY + "!"),
		FASTCLICKDEFINITIVAMENTE(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Definitivamente estar ("
				+ API.RED + "Clicando muito Rápido" + API.GRAY + ") clicks Click's " + API.DARK_RED + "[" + "avisos"
				+ "]" + API.GRAY + "!"),

		MACROTALVEZ(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Talvez estar usando (" + API.RED
				+ "Macro" + API.GRAY + ") clicks Click's " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY + "!"),
		MACROPROVAVELMENTE(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Provavelmente estar usando ("
				+ API.RED + "Macro" + API.GRAY + ") clicks Click's " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY
				+ "!"),
		MACRODEFINITIVAMENTE(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY
				+ ") Definitivamente estar usando (" + API.RED + "Macro" + API.GRAY + ") clicks Click's " + API.DARK_RED
				+ "[" + "avisos" + "]" + API.GRAY + "!"),

		FORCEFIELDTALVEZ(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Talvez estar usando (" + API.RED
				+ "ForceField" + API.GRAY + ") " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY + "!"),
		FORCEFIELDPROVAVELMENTE(
				API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Provavelmente estar usando (" + API.RED
						+ "ForceField" + API.GRAY + ") " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY + "!"),
		FORCEFIELDDEFINITIVAMENTE(
				API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Definitivamente estar usando (" + API.RED
						+ "ForceField" + API.GRAY + ") " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY + "!"),

		FLY(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") pode estar (" + API.RED + "Voando" + API.GRAY
				+ ") ping de MS " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY + "!"),

		SPEED(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") pode estar usando (" + API.RED + "Speed"
				+ API.GRAY + ") ping de MS " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY + "!"),

		AUTOSOUPTALVEZ(API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Talvez estar usando (" + API.RED
				+ "Auto-Soup" + API.GRAY + ") " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY + "!"),
		AUTOSOUPPROVAVELMENTE(
				API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Provavelmente estar usando (" + API.RED
						+ "Auto-Soup" + API.GRAY + ") " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY + "!"),
		AUTOSOUPDEFINITIVAMENTE(
				API.PrefixStaffer + "(" + API.YELLOW + "nick" + API.GRAY + ") Definitivamente estar usando (" + API.RED
						+ "Auto-Soup" + API.GRAY + ") " + API.DARK_RED + "[" + "avisos" + "]" + API.GRAY + "!");
