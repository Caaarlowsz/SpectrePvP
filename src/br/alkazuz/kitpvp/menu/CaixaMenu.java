...
import br.alkazuz.kitpvp.utils.BoxScroller;
import br.alkazuz.kitpvp.utils.RDItem;
...
public class CaixaMenu {
	...
	public CaixaMenu(Player p) {
		this.p = p;
		itens_list.add(KitMenu.createItemMenu(Material.EXP_BOTTLE, "§aMoney - 700",
				new String[] { "§fMais §e700 §fem sua conta" }));
		itens_alt.put(
				KitMenu.createItemMenu(Material.EXP_BOTTLE, "§aMoney - 700",
						new String[] { "§fMais §e700 §fem sua conta" }),
				new RDItem(KitMenu.createItemMenu(Material.EXP_BOTTLE, "§aMoney - 700",
						new String[] { "§fMais §e700 §fem sua conta" })));

		itens_list.add(KitMenu.createItemMenu(Material.EXP_BOTTLE, "§aMoney - 1500",
				new String[] { "§fMais §e1500 §fem sua conta" }));
		itens_alt.put(
				KitMenu.createItemMenu(Material.EXP_BOTTLE, "§aMoney - 1500",
						new String[] { "§fMais §e1500 §fem sua conta" }),
				new RDItem(KitMenu.createItemMenu(Material.EXP_BOTTLE, "§aMoney - 1500",
						new String[] { "§fMais §e1500 §fem sua conta" })));

		itens_alt.put(
				KitMenu.createItemMenu(Material.EXP_BOTTLE, "§aMoney - 1700",
						new String[] { "§fMais §e1700 §fem sua conta" }),
				new RDItem(KitMenu.createItemMenu(Material.EXP_BOTTLE, "§aMoney - 1700",
						new String[] { "§fMais §e1700 §fem sua conta" })));
		itens_list.add(KitMenu.createItemMenu(Material.EXP_BOTTLE, "§aMoney - 1700",
				new String[] { "§fMais §e1700 §fem sua conta" }));
