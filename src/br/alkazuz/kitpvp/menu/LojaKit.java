...
public class LojaKit {
	...
	public static ItemStack createItemMenu(Kit kit) {
		...
		kitem.setLore(Arrays.asList(new String[] { "", "§fPreço desse Kit §e" + MenusAPI.money(kit.getPrice()) }));
	...
	public static void OpenInventory(Player p) {
		Inventory inv = Bukkit.createInventory(p, 54, "§aLoja de Kits");
