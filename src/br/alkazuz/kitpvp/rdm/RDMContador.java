...
public class RDMContador {
				...
				if (Iniciando == 0) {
					if (RDMApi.playing.size() < 10) {
						Bukkit.broadcastMessage(
								"�4�lRDM �fO Evento n�o pode ser iniciado porque n�o h� Jogadores Suficientes");
						...
						Bukkit.broadcastMessage(
								"�4�lRDM �fH� �c" + RDMApi.playing.size() + " �fjogadores Participando");
	...
	private void mandarAvisos() {
		...
		Bukkit.broadcastMessage("�4�lRDM �fH� �c" + RDMApi.playing.size() + " �fjogadores Participando");
